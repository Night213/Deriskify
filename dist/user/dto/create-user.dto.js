...
const is_egyptian_national_id_validator_1 = require("../../lib/validators/is-egyptian-national-id.validator");
class CreateUserDto {
    nationalId;
    fullName;
    phone;
...
__decorate([
    ...
    (0, is_egyptian_national_id_validator_1.IsEgyptianNationalId)(),
...
__decorate([
    ...
    (0, class_validator_1.IsMobilePhone)('ar-EG', { strictMode: false }, {
